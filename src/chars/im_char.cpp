...
bool Utf8StrToImCharStr(UIState& ui_state, WrapColumn* wrap_p, const std::string& str, int line, int start, int end, const Style& style, bool replace_spaces_by_points) {
    //ZoneScoped;
    if (start == end)
        return true;
...
bool Utf8StrToImCharStr(UIState& ui_state, WrapString* wrap_str, const std::string& str, int line, int start, int end, const Style& style, bool replace_spaces_by_points) {
    if (start == end)
        return true;
